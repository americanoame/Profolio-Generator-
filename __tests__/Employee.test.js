...
test("Test instantiate Employee instance", () => {
  const employee = new Employee('peter', 2, 'peter@gmail.com', 'email', 'github')
...
test("Test setting name of an employee", () => {
  ...
  // Instantiate the Employee class, passing the variable of the employee name as an augument, 
  // to create an object and assign it to an new variable
...
test("Test setting id of an employee", () => {
  ...
  // Instantiate the Employee class with an employee name of your choice and the id 
  // variable as input arguments to create an employee object and assign it to a new variable
...
test("Test setting email of an employee", () => {
  ...
  // Instantiate the Employee class, passing a name and an id and the email variable as input 
  //arguments, to create an employee object and assign it to a new variable
  // Expect the email of the employee object to be equal to the value of the email variable
});

// Test get name method
test("Test get name method", () => {
  const peter = new Employee('peter')
